...
class ListingsController extends Controller
{
    ...
    {
        //
        return  view('showlisting')->with('listing',Listing::findOrFail($id));
    }
    ...
    {
        //
        return  view('editlisting')->with('listing',Listing::findOrFail($id));
    }
...
//        $listing->user_id = auth()->user()->id;
    ...
    public function destroy($id)
    {
        ...
        if(auth()->user()->id != $list->user->id){
            return redirect('/dashboard')->with('error','Unauthorize Access');
        }
        $list->delete();
